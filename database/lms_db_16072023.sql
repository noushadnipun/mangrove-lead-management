...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2023 at 06:14 AM
...
(6, 8, 'Noushad', '', '', 'Male', '2023-07-15', '01823633792', 'admin@system.com', '', '', '2023-07-14 01:46:11', NULL);
...
CREATE TABLE `lead_list` (
  ...
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '0 = New/Prospect,\r\n1 = Open,\r\n2 = Working,\r\n3 = Not a Target,\r\n4 = Disqualified,\r\n5 = Nurture,\r\n6 = Opportunity Created,\r\n7 = Opportunity Lost,\r\n8 = Inactive',
...
(8, '202307-00001', 2, '', '', 9, 1, 0, 0, 0, '2023-07-14 01:46:11', NULL);
